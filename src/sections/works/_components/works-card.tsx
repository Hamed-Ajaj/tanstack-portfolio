	...
	return (
		<div className="flex w-full flex-col gap-3">
			<div className="space-y-1.5 sm:hidden">
				...
				<CardDescription className="mt-0 max-w-none text-sm leading-relaxed text-foreground/65">
					{description}
				</CardDescription>
			</div>
			<Card
				className="relative aspect-video w-full cursor-pointer overflow-hidden transition-transform duration-150 ease-out-quad hover:-translate-y-0.5"
				role="link"
				tabIndex={0}
