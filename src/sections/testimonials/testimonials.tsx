...
export default function Testimonials() {
  ...
  return (
    ...
    <Section
      id="testimonials"
      title="Collaboration that speaks for itself"
      description="I value clarity, technical transparency, and consistent communication — the result is software clients can rely on."
